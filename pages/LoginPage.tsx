    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden lg:flex lg:w-2/3 bg-white p-8">
        ...
        <div className="absolute bottom-8 left-8 right-1/3">
          ...
          <div className="flex items-center space-x-6 opacity-60">
            ...
            <div className="bg-gray-800 text-white px-3 py-1 rounded text-sm">Häagen-Dazs</div>
      ...
      <div className="w-full lg:w-1/3 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          {/* Google Sign Up */}
          <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors mb-4 text-gray-800">
